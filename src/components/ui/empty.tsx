    ...
    >
      <div className="flex justify-center isolate">
        {icons.length === 3 ? (
          ...
          <div className="bg-gray-100 size-16 grid place-items-center rounded-full ring-2 ring-border group-hover:-translate-y-0.5 transition duration-500 group-hover:duration-200">
            {icons[0] &&
              React.createElement(icons[0], {
